  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
         <div class="col-lg-12">
          <h3 class="page-header"><i class=""></i> Create Loans</h3>
          <ol class="breadcrumb">
   ...
   <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        <h4 style="color:#000000" class="panel-title">Create new loan</h4>
...
<!-- ############################################## responsive table design -->
              ...
              <?php
	         include('../conn.php');
		     $sql = "select * from loan_types order by loan_type_id desc";
		 ...
		 while($row = $query->fetch_array()){
            ...
            <tr>
			  ...
			  <td><a href="loan_pdfs/<?php echo $row['loan_attachment_name']; ?>"> loan requirements</td>
			  <td>
               <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#modal<?php echo $row['loan_type_id']; ?>" data-toggle="modal" >Update</a></li>
                  <li><a href="#del<?php echo $row['loan_type_id']; ?>" data-toggle="modal" >Delete</a></li>
                </ul>
              </div>
            </td>
          </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="form-group">
         ...
         <input type="text" name="loan_type" value="" class="form-control" id="exampleInputPassword1" required>
       </div>
	  <div class="form-group">
         <label for="exampleInputPassword1">Loan Rate/Month</label>
         <input type="text" name="loan_rate" value="" class="form-control" id="exampleInputPassword1"  required>
       </div>
	    <div class="form-group">
         <label for="exampleInputPassword1">upload pdf Requirements</label>
         <input type="file" name="attach_ment" value="" id="exampleInputPassword1"  required>
       </div>
